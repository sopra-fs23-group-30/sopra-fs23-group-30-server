...
class ListingFilterTest {
    ...
    void sortValue_validInput_4expected() {
        ListingFilter listingFilter = new ListingFilter("Hello world", 2000, 10, SortBy.PRICE_ASCENDING);
        ...
        listingEntity.setStreetName("Friedhofsplatz");
        listingEntity.setStreetNumber("8");
    ...
    void sortValue_validInput_minValueExpected() {
        ListingFilter listingFilter = new ListingFilter("Hello world", 10, 2000, SortBy.PRICE_ASCENDING);
