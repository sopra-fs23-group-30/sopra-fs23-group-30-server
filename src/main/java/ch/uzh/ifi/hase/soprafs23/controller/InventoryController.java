...
public class InventoryController {
      ...
      public ResponseEntity<Object> addInventoryItem(@RequestBody InventoryItemPostDTO inventoryItemDTO) {
            InventoryItemEntity inventoryItemEntity = DTOMapper.INSTANCE
                        .convertInventoryItemPostDTOtoInventoryItemEntity(inventoryItemDTO);
            InventoryItemEntity createdItem = inventoryItemService.createInventoryItem(inventoryItemEntity);
            InventoryItemGetDTO inventoryItemGetDTO = DTOMapper.INSTANCE
                        .convertInventoryItemEntityDTOtoInventoryItemGetDto(createdItem);
      ...
      public ResponseEntity<Object> updateInventoryItem(@PathVariable UUID inventoryId,
            ...
            InventoryItemGetDTO inventoryItemGetDTO = DTOMapper.INSTANCE
                        .convertInventoryItemEntityDTOtoInventoryItemGetDto(updatedItem);
